...
class Pallete {
  ...
  static const Color assistantCircleColor = Color.fromRGBO(78, 121, 219, 1);
  static const Color borderColor = Color.fromRGBO(200, 200, 200, 1);
  static const Color blackColor = Colors.black;
  static const Color whiteColor = Colors.white;

  static const Color kAppTheme = Color(0xFF1D1843);
  static const Color kAppBar = Color(0xFF1D1843);
}
